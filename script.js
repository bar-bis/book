...
let cards = document.querySelectorAll(".memory"); //NodeList; metoda getElementsByTagName tworzy HTMLCollection
...
const clickCard = function () {
    ...
    activeCard.classList.remove("hid"); //ukrycie karty, która została kliknięta
